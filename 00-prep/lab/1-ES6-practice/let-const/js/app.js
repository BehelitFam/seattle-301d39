...
function displayPics(){
  ...
  // let's scope in this case only exists within the block of code inside the while loop. When we try to log rando 
  // outside this loop, it is outside the scope of this let. 
  console.log(viewed);
