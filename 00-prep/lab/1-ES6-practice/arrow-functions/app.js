...
let Student = function(name, age, hometown) { // arrow functions cannot be used with or as constructors. 
  this.name = name;
  this.age = age;
  this.hometown = hometown;
};

let joe = new Student('Joe', 'Schmoe', 100); // arrow functions cannot be used with or as constructors.

// TODO: Uncomment the following line of code to see the output in the browser console
// Note that the arrow function will cause this code to break!
console.log(joe);

Student.prototype.greeting = () => `Hi, my name is ${this.name}`; // can't refer to this
...
//  "this" refers to the Student object referred to by the variable "joe".
// 2. What is "this" when joe.scopeArrow() is invoked?
//  "this" refers to the Window object. 
// 3. Explain why "this" is different when an arrow function is used.
//  Arrow functions do not have a "this" property; "this" when used with an arrow function
//  refers to their containing function or object. In the case of joe.scopeArrow(), because it is not 
//  nested within another function or object, "this" refers to the Window object, as it is the only object
// "above" the arrow function defining .scopeArrow.
